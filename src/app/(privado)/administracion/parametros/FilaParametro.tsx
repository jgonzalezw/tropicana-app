...
export default function FilaParametro({ parametro }: { parametro: Parametro }) {
  ...
  return (
    <div className="py-4 border-t border-[var(--borde)] first:border-t-0">
      {/* El mensaje de error va AFUERA de esta fila (abajo del todo), no como
          tercer hijo acá adentro: con `sm:flex-row` un hijo `w-full` no baja de
          línea solo, empuja y deforma el campo y el botón al costado. */}
