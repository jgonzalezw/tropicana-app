...
-- Concatenacion en orden de las migraciones 0001..0014.
-- Pegar TODO en Supabase -> SQL Editor -> New query -> Run (una vez).
-- Idempotente. Solo ASCII en este encabezado. Generado (no editar a mano).
-- =====================================================================
...
-- ============================ 0014_planes_acceso_ilimitado.sql ============================
-- =====================================================================
