...
1. **Migración pendiente de aplicar: `0010_motor_planes_liquidacion`** (motor de planes + liquidación, sub-hito 1A) — construida y validada en local; falta aplicarla en Supabase tras el OK de Javier. `0001→0009` ya aplicadas.
