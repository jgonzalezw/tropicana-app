...
> **Estado al 2026-09-24.** D1 y D2 ya están **cerradas** (D1 el 2026-09-24,
...
> reservas, R1). **Lo siguiente es C3**: la venta de particulares y alquiler.
> El texto de abajo es el encuadre del 2026-09-12 que sigue gobernando ese
> trabajo.
>
...
| D5 | **Clasificar mejor el motivo del cobro** en el recibo: Membresía, Clase Particular, Clase de Prueba, Alquiler, Taller, Venta Producto, Ajuste. | **DECIDIDA — Javier confirmó el 2026-09-12** (*"Correcto"*). **El catálogo ya existe**: `motivo_cobro` tiene los siete motivos desde la migración **0020** (medido en dev el 2026-09-24). Solo falta que la venta de C3 elija el motivo sola (`clase_particular` / `alquiler`) en vez de pedirlo a mano. | Se resolvió lo urgente (que el motivo elegido no se descarte). | **Se termina en C3**, al construir la venta de particulares y alquiler. |
