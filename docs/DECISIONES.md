...
- **Último hito:** H3 (reservas con los 7 estados) — construido y verificado
  ...
  encontrados y corregidos en el camino), **falta que Javier lo pruebe en su
  propio local** antes del OK de pase. Detalle en `docs/ESTADO.md`, sección
