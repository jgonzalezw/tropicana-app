...
> §1.b. D6 además ya está construida. Lo que falta para arrancar es el
> **alcance** (Paso 5 completo o validación mínima dentro de 2D) y si
> particulares va Design-first o código v1 (regla de proceso 3).
