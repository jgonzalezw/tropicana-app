...
- **Rama activa:** `main` — H1 + H2 + H3 (y el cambio de WhatsApp app-primero)
  **pasaron a producción el 2026-09-26**, por fast-forward de
  `claude/adoring-maxwell-2car0j` (PR #1). No queda nada solo en dev.
- **Último hito:** H3 (reservas con los 7 estados), probado por Javier en su
  local en dos rondas y en producción. Detalle en `docs/ESTADO.md`, sección
  "C3 — H3: reservas con los 7 estados".
