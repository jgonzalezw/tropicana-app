...
| D5 | **Clasificar mejor el motivo del cobro** en el recibo: Membresía, Clase Particular, Clase de Prueba, Alquiler, Taller, Venta Producto, Ajuste. | **DECIDIDA — Javier confirmó el 2026-09-12** (*"Correcto"*). **El catálogo ya existe**: `motivo_cobro` tiene los siete motivos desde la migración **0020** (medido en dev el 2026-09-24). Solo falta que la venta de C3 elija el motivo sola (`clase_particular` / `alquiler`) en vez de pedirlo a mano. | Se resolvió lo urgente (que el motivo elegido no se descarte). | **Se termina en C3, hito H2** (venta del plan de particulares), al construir la venta de particulares y alquiler. |
