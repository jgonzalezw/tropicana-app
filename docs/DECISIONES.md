...
| D17 | **Profesor ausente: suspensión o reemplazo, y el descuento del reemplazante.** Al tomar asistencia hay que poder registrar cuál de las dos fue y, si hubo reemplazo, **quién reemplazó**. La clase dictada con reemplazante **liquida igual al titular** (es el asignado oficialmente); el reemplazante **nunca aparece como parte de la liquidación, sino como descuento**: si la falta es injustificada, se le descuenta al titular lo que se pagó por el reemplazo, más cualquier multa. Javier (2026-09-12): *"simplemente le descuentas al profesor en su liquidación lo que se pagó por reemplazos o cualquier multa que se le aplique."* | **Pendiente — planificable** (2026-09-12) | No es crítico hoy y necesita el catálogo de motivos (D12). | Antes de que haya muchas liquidaciones hechas: es un concepto nuevo en el comprobante (un descuento, no una comisión). |
| D18 | **La comisión debe seguir a quién dictó, no a quién está asignado hoy.** `asignaciones` ya tiene `desde` / `hasta`, pero el cálculo del prorrateo lee **solo** las vigentes (`hasta is null`) y toma la más reciente: si a mitad de mes se cambia el titular de un curso, **toda** la comisión del mes se le atribuye al nuevo, y el anterior no cobra las clases que sí dictó. Verificado en el código (`liquidaciones/acciones.ts`, paso 7) y en los datos de dev, donde ya hay una asignación cerrada. Javier (2026-09-12): *"puede haber más de un profesor que dictó la misma clase… es parte del diseño desde el inicio."* | **Pendiente — es un bug, no una mejora** (2026-09-12) | Apareció al revisar D16. Cambia la forma de la comisión: la parte de un curso pasa a repartirse entre los profesores que lo dictaron, cada uno con su % y sus clases. | **Antes del pase a producción**, o apenas se cambie el titular de un curso por primera vez — el primer cambio de asignación a mitad de período ya paga mal. |
