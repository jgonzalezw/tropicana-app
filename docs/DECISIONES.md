...
| D17 | **Profesor ausente: suspensión o reemplazo, y el descuento del reemplazante.** Al tomar asistencia hay que poder registrar cuál de las dos fue y, si hubo reemplazo, **quién reemplazó** y **cuánto se le paga** — el monto se confirma en ese momento, tomando como referencia la tarifa del profesor. El **suplente cobra por tarifa, nunca por liquidación**, y no entra en el prorrateo (regla de negocio 20). Dos casos distintos: si la clase la dio un suplente porque el **titular faltó sin justificar**, se le descuenta al titular en su liquidación lo pagado por el reemplazo más cualquier multa; si el curso estaba **desasignado**, el costo es de la **administración** y no se le descuenta a nadie. Además: al tomar asistencia hay que **ver el titular vigente**, y si el curso está desasignado ese día el reemplazo es **obligatorio** salvo que la clase se cancele. Javier (2026-09-12): *"simplemente le descuentas al profesor en su liquidación lo que se pagó por reemplazos o cualquier multa que se le aplique."* | **Pendiente — planificable** (2026-09-12) | No es crítico hoy y necesita el catálogo de motivos (D12). El descuento es un concepto nuevo en el comprobante: no es una comisión. | Antes de que haya muchas liquidaciones hechas. **Mientras tanto**, una clase sin titular asignado ya no se devenga a nadie y el comprobante la marca "suplente" — la plata no se pierde en silencio, pero al suplente todavía hay que pagarle por fuera del sistema. |
